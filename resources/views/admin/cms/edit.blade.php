                    ...
                    <div class="row">
                        <div class="col-12 connectedSortable">
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="{{route('admin.update.cms')}}" method="post">
                                @csrf
                                <input type="hidden" name="id" value="{{$id}}">
                                    <div class="card-body">
                                        <div class="form-group input-style-wrap">
                                            <label for="page_name">Page Name</label>
                                            <input type="text" name="page_name" class="form-control input-style" id="page_name" value="{{$cms->page_name}}" placeholder="Page Name">
                                        </div>
                                        <div class="form-group input-style-wrap">
                                            <label for="desc">Page Content</label>
                                            <textarea class="form-control ckeditor" id="desc" name="content">{{$cms->content}}</textarea>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
