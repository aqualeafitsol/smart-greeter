                                ...
                                @csrf
                                    <div class="card-body">
                                        <div class="form-group input-style-wrap">
                                            ...
                                            <input type="text" name="name" class="form-control input-style" id="name" value="" placeholder="Plan Name">
                                        </div>
                                        <div class="form-group input-style-wrap">
                                            <label for="price">Price</label>
                                            <input type="text" name="price" class="form-control input-style" id="price" value="" placeholder="Enter Price">
                                        </div>
                                        <div class="form-group input-style-wrap">
                                            <label for="desc">Plan Details</label>
                                            <textarea class="form-control input-style" id="desc" name="description" placeholder="Enter Description"></textarea>
                                        </div>
                                        <div class="row">
                                                ...
                                                <div class="plan-wrap-main shadow-box">
                                                    <div class="plan-wrap">                                    
                                                        <div class="add-plan-wrap">
                                                            ...
                                                            <div class="form-group input-style-wrap">
                                                                <input type="text" placeholder="Enter Package name" id="plan_package" name="plan_package[]" class="form-control input-style">
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="shadow-box plan-visible-wrap">
                                                    ...
                                                    <ul class="d-flex flex-wrap">
                                                        <li class="checkbox">
                                                            <input type="checkbox" id="ck1" name="daily_visit">
                                                            <label for="ck1">Daily Visits</label>
                                                        </li>
                                                        <li class="checkbox">
                                                            <input type="checkbox" id="ck2" name="platform_used">
