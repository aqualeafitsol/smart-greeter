                                ...
                                @csrf
                                    <div class="card-body">
                                        <div class="form-group input-style-wrap">
                                            ...
                                            <input type="text" name="question" class="form-control input-style" id="question" value="{{isset($faq)?$faq->question:''}}" placeholder="Question">
                                        </div>
                                        <div class="form-group input-style-wrap">
                                            <label for="ans">Answer</label>
                                            <textarea class="form-control input-style" id="ans" name="ans" placeholder="Enter Answer" style="height: 100px;">{{isset($faq)?$faq->ans:''}}</textarea>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                                    ...
                                    <div class="card-footer">
                                        ...
                                        @else
                                            <button type="submit" class="btn btn-primary ftr-save-btn">Add</button>
                                        @endif
                                    </div>
                                </form>
                            </div>
